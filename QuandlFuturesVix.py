...
Returns: pandas.DataFrame
    Columns: [Trade Date, Settle, Close, ContractName, VIX Close]
    ...
"""

"""TODO: CLEAN DATA all 3 Columns"""
...
class QuandlFuturesVix:
    ...
    def write_to_files(self):
        ...
        self.complete_data.to_csv('./data/' + time_str + 'quandl_futures_vix.csv', index=True)
        self.complete_data.to_excel('./data/' + time_str + 'quandl_futures_vix.xlsx', sheet_name='VIX Futures Prices', index=True)
        print 'Complete!'
        pass
